...
def unet(pretrained_weights=None, input_size=(IMAGE_SIZE, IMAGE_SIZE, 3), num_class=20) :
    ...
    model.compile(optimizer=Adam(lr=1e-5), loss=[multi_DE_loss], metrics=['accuracy'])
    model.summary()
